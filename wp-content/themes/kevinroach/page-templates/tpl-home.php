...
<div id="feature-items">
    <div id="books-wraper" class="container">
        <div class="span4 books_list_check grow first-book">
            <div class="book-cont ">
        ...
        <div class="span4 books_list_check grow second-book">
            <div class="book-cont">
                <div class="book_innercent">
        ...
        <div class="span4 zero-mar hidden-phone hidden-tablet hidden_all grow test-word">
            <div class="book-cont">
